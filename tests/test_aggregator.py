...
class TestTrimmedMean:
    ...
    def test_identical_updates(self):
        ...
        updates = [np.array([1.0, 2.0, 3.0]), np.array([1.0, 2.0, 3.0]), np.array([1.0, 2.0, 3.0])]
        result = trimmed_mean(updates, 0.1)
...
class TestCoordinateMedian:
    ...
    def test_multiple_updates(self):
        ...
        updates = [np.array([1.0, 4.0]), np.array([2.0, 5.0]), np.array([3.0, 6.0])]
        result = coordinate_median(updates)
...
class TestHybridAggregator:
    ...
    def test_basic_functionality(self):
        ...
        updates = [np.array([1.0, 2.0, 3.0]), np.array([1.1, 2.1, 3.1]), np.array([0.9, 1.9, 2.9])]
    ...
    def test_staleness_weighting(self):
        ...
        updates = [np.array([1.0, 2.0, 3.0]), np.array([10.0, 20.0, 30.0])]
