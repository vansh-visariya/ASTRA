      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-950 border border-gray-800 rounded-lg py-3 px-4 text-white focus:outline-none focus:border-white/25"
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-white/10 hover:bg-white/20 disabled:opacity-50 rounded-lg text-white text-sm flex items-center gap-2 transition"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3">
              {recommendations.map((rec) => (
                ...
                >
                  ...
                  <p className="text-gray-300 text-xs mt-1">Acc: {(rec.expected_accuracy * 100).toFixed(0)}%</p>
            ...
            {!showHfForm ? (
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white/10 hover:bg-white/20 disabled:opacity-50 rounded-lg text-white text-sm flex items-center gap-2"
                >
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs px-2 py-0.5 rounded bg-white/5 text-gray-300">huggingface</span>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs px-2 py-0.5 rounded bg-white/5 text-gray-300">custom</span>
              </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className={`text-xs px-2 py-0.5 rounded ${
                    model.model_type === 'vision' ? 'bg-white/5 text-gray-300' :
                    model.model_type === 'text' ? 'bg-white/5 text-gray-300' :
                    'bg-white/5 text-gray-300'
                  }`}>
                    {model.model_type}
                  </span>
                  {model.is_peft && <span className="text-xs text-gray-300">PEFT</span>}
                </div>
                    ...
                    {hfResults.map((name) => (
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 text-sm border-b border-gray-800 last:border-b-0 transition ${
                          hfModelName === name ? 'bg-white/5 text-gray-300' : 'text-gray-300 hover:bg-gray-900'
                        }`}
                      >
                        {name}
                      </button>
                ...
                <div className="mt-3 flex items-center gap-3">
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg border text-sm transition ${
                      hfUsePeft
                        ? 'bg-white/5 border-white/25 text-gray-300'
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-white/10 hover:bg-white/20 disabled:opacity-50 rounded-lg text-white font-medium transition flex items-center gap-2"
          >
            {loading ? (
