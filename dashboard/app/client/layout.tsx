        ...
        <div className="p-5 pb-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: 'rgba(16,185,129,0.12)' }}>
              <span className="font-mono font-bold text-sm" style={{ color: 'var(--signal-emerald)' }}>A</span>
            </div>
            <div>
              <h1 className="font-display font-bold text-[15px] text-white">astra</h1>
              <p className="section-label mt-0.5">Client Portal</p>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                {item.href === '/client/notifications' && unreadCount > 0 && (
                  <span className="ml-auto text-white text-[10px] font-bold px-1.5 py-0.5 rounded-md min-w-[20px] text-center"
        ...
        <header className="h-14 header-bar flex items-center justify-between px-6 shrink-0 relative">
          ...
          <div className="flex items-center gap-2">
            <Link
              ...
              className="relative p-2 text-slate-500 hover:text-slate-300 rounded-lg transition"
            >
              <Bell size={16} />
              {unreadCount > 0 && (
