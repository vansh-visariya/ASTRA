...
def setup_logging(log_dir: Path, jsonl_logging: bool = True, level: int = logging.INFO) -> None:
    """
...
class JSONLLogger:
    ...
    def __init__(self, log_path: Path):
        ...
        self.file_handle = open(self.log_path, "a")  # noqa: SIM115
...
class ExperimentMetadata:
    ...
    def _get_pip_freeze(self) -> str | None:
