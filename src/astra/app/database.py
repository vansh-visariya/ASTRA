...
class AstraDB:
    ...
    def log_metrics(
        self, experiment_id: str, step: int, metrics: dict, group_id: Optional[str] = None
    ) -> None:
        with self.connection() as conn:
            conn.execute(
    ...
    def register_fl_client(
        self, client_id: str, experiment_id: str, user_id: Optional[int] = None, group_id: str = None
    ) -> None:
        with self.connection() as conn:
            conn.execute(
