...
class Notification:
    ...
    title: str = ""
    message: str = ""
    user_id: int | None = None  # None = broadcast
...
class NotificationDatabase:
    ...
    def get_for_user(
        self, user_id: int | None, limit: int = 50, unread_only: bool = False
    ) -> list[Notification]:
...
class NotificationService:
    ...
    def notify_join_rejected(self, user_id: int, group_id: str, reason: Optional[str] = None):
